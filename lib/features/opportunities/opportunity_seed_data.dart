...
const sourcedVentureOpportunitySeeds = [
  ...
  VentureOpportunitySeed(
    ...
    aluConnection: 'Founded by ALU alumni.',
    opportunity: Opportunity(
      id: 'demo-kayko-customer-research',
      role: 'Customer research practice project',
      startup: 'Kayko',
      summary: 'Practice mapping how small businesses understand cash flow.',
      location: 'Remote',
      commitment: '6 hrs / week',
      skills: ['User interviews', 'Synthesis', 'Fintech'],
      match: 86,
      color: Color(0xff68ddc9),
    ),
  ),
  VentureOpportunitySeed(
    ...
    aluConnection: 'Founded by an ALU alumnus.',
    opportunity: Opportunity(
      id: 'demo-rwazi-dashboard-practice',
      role: 'Market dashboard practice project',
      startup: 'Rwazi',
      summary: 'Build a concise dashboard concept from sample market data.',
      location: 'Remote',
      commitment: '8 hrs / week',
      skills: ['Data visualization', 'SQL', 'Product thinking'],
      match: 91,
      color: Color(0xff9fa8ff),
      isPaid: true,
      monthlyAmount: 200,
  ...
  VentureOpportunitySeed(
    ...
    aluConnection: 'Led by an ALU graduate featured on the ALU website.',
    opportunity: Opportunity(
      id: 'demo-starlight-field-campaign',
      role: 'Field campaign practice project',
      startup: 'Starlight',
      summary: 'Practice planning a community solar-lantern activation.',
      location: 'Rwanda · Hybrid',
      commitment: '7 hrs / week',
      skills: ['Campaign planning', 'Community outreach', 'Budgeting'],
      match: 84,
      color: Color(0xffffc66b),
      isPaid: true,
  ...
  VentureOpportunitySeed(
    ...
    aluConnection: 'Co-founded by an ALU student innovator.',
    opportunity: Opportunity(
      id: 'demo-smartel-service-design',
      role: 'Service design practice project',
      startup: 'Smartel Agri-tech',
      summary: 'Map a sample farmer journey and identify service gaps.',
      location: 'Hybrid',
      commitment: '6 hrs / week',
      skills: ['Service design', 'Journey mapping', 'Agriculture'],
      match: 81,
      color: Color(0xff68ddc9),
    ),
  ),
  VentureOpportunitySeed(
    ...
    aluConnection: 'Co-founded by an ALU/ALX student.',
    opportunity: Opportunity(
      id: 'demo-signvrse-content-design',
      role: 'Inclusive content practice project',
      startup: 'Signvrse',
      summary: 'Create a plain-language onboarding concept for diverse users.',
      location: 'Remote',
      commitment: '5 hrs / week',
      skills: ['Content design', 'Accessibility', 'Prototyping'],
      match: 87,
      color: Color(0xffffc66b),
      isPaid: true,
      monthlyAmount: 180,
  ...
  VentureOpportunitySeed(
    ...
    aluConnection:
        'Supported by the ALU Centre for Entrepreneurial Leadership.',
    opportunity: Opportunity(
      id: 'demo-drifter-qa-practice',
      role: 'Hardware QA practice project',
      startup: 'Drifter Innovations',
      summary: 'Draft test scenarios for a sample smart-vending workflow.',
      location: 'Kigali · On-site',
      commitment: '9 hrs / week',
      skills: ['QA testing', 'Hardware', 'Mobile Money'],
      match: 79,
      color: Color(0xff9fa8ff),
      isPaid: true,
